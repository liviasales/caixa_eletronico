...
<div class="content p-1">
	<div class="list-group-item" style="background-color: #eaeef3">                    
		<div class="mr-auto p-2">
			<h2 class="text-center"> Banco XYZ <i class="fa fa-money-check-alt"></i></h2><br>
		</div>
			<!-- Iniciando a Tabela -->
			<div class="table-responsive">
				<table class="table table-hover">
					...
					<tbody>
						<?php foreach($contas->getInfo($id) as $accont_info): ?>						
						<tr class="tr">
							<td><?php echo $accont_info['id']; ?></td>
							<td><?php echo $accont_info['titular']; ?></td>
							<td><?php echo $accont_info['agencia']; ?></td>
							<td><?php echo $accont_info['conta']; ?></td>
				...
				<!-- Fim - Tabela -->
				<!-- Formulario JQuery -->
				<form method="POST" action="../controller/transaction_controller.php" style="font-weight: bold; font-style: italic;" class="formulario">					
				...
				<div class="table-responsive">
					<table class="table table-hover">
						...
						<tbody style="text-align: center;">
							...
							<tr>
								<td><?php echo date("d/m/Y H:m:s", strtotime($historic['data_operacao'])); ?></td>								
								<?php if ($historic['tipo'] == "Deposito"): ?>
								<td style="color: green;">R$ <?php echo $historic['valor']; ?></td>
								<?php else: ?>
								<td style="color: red;">-R$ <?php echo $historic['valor']; ?></td>								
								<td><?php echo $historic['tipo']; ?></td>
								<?php endif; ?>
							</tr>
							<?php endforeach; ?>							
						</tbody>
