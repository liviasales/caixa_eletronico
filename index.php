            ...
            <div class="content p-1">
                <div class="list-group-item" style="background-color: #eaeef3">                    
                        <div class="mr-auto p-2">
                            <h2 class="text-center"> Banco XYZ <i class="fa fa-money-check-alt"></i></h2><br><br>
                        </div>
                        <!-- Iniciando a Tabela -->
                        <div class="table-responsive">
							<table class="table table-hover">
								...
								<tbody>
									<?php foreach($contas->listAccounts() as $accont): ?>									
									<tr class="tr">
										<td><?php echo $accont['id']; ?></td>
										<td><?php echo $accont['titular']; ?></td>
										<td><?php echo $accont['agencia']; ?></td>
										<td><?php echo $accont['conta']; ?></td>
										<td><?php echo $accont['saldo']; ?></td>
										<!-- Formulario para Transação -->
										<td>
						<form method="POST" action="view/add_transacao.php">
							<!-- Botão para Transação -->
							<input type="hidden" name="id" value="<?=$accont['id']?>">
